...
DATASET_MODULES = {
    ...
    'RotateRatioDataSetTVResize': 'tools.data.ratio_dataset_tvresize',
    'RotateRatioDataSetTVResizeTest': 'tools.data.ratio_dataset_tvresize_test',
...
def build_dataloader(config, mode, logger, seed=None, epoch=1, task='rec'):
    ...
    persistent_workers = (loader_config.get('persistent_workers', True)
                          and num_workers > 0)
    prefetch_factor = (loader_config.get('prefetch_factor', 4)
