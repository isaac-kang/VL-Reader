...
def build_metric(config):
    ...
    elif module_name == 'VLReaderPhase1Metric':
        from .vlreader_phase1_metric import VLReaderPhase1Metric
        module_class = VLReaderPhase1Metric(**config)
